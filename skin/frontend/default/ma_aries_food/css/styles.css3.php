...
.ma-featuredproductslider-container .flex-direction-nav a, .ma-newproductslider-container .flex-direction-nav a, .ma-upsellslider-container .flex-direction-nav a, #back-top, .top-cart-wrapper, .header .form-search, .ma-brand-slider-contain .flex-direction-nav a, .banner-static2 .banner-box2 .content ul li a, .pager .pages .current, .ma-thumbnail-container .flex-direction-nav a, .product-view .add-to-cart button.button span {
    border-radius: 40px;
...
.block-tags .block-content .tags-list a{
    ...
    -moz-box-shadow: inset 0 0 20px #f7f7f7;
}
